...
**Plan:** Реализовать динамическую страницу `/orders/[id]`, отображающую детали заказа на основе мок-данных, с сохранением стиля приложения и подготовкой к замене данных на реальные источники в будущем.
...
- Использовать Nuxt Layout, если у приложения есть общий layout для страниц заказов (проверить текущую структуру; при отсутствии — использовать `<div>` контейнер с нужными классами).
