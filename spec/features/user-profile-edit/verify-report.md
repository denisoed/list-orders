...
- ✅ Supporting tasks — документация обновлена, добавлен лог сохранения в сторе, подготовлены тесты и отчёт.
...
- ✅ spec/features/user-profile-edit/tasks.md — отмечены выполненные пункты и подтверждён DoD.
